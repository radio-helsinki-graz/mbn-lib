...
\end{verbatim}
Defines an object message. \textit{Number} starts at 1024 for custom objects, default node objects start from 0.
% TODO: document object actions?
...
\end{verbatim}
Defines a custom object. \textit{SensorData} and \textit{ActuatorData} refer to the ``current'' data in use.
